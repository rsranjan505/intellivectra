        ...
        <div class="container-fluid py-4 wow fadeInUp bg-primary" data-wow-delay="0.1s" >
            <div class="container">
                ...
                <div class="col-lg-12 p-2">
                    <a class="btn text-primary d-flex flex-row justify-content-end " href="{{route('oems')}}"> See All <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right mt-1" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
                      </svg></a>
                </div>
            </div>
                                                ...
                                                <div class="blog-item bg-light rounded overflow-hidden">
                                                    ...
                                                    <div class="p-4">
                                                        <div class="d-flex mb-3">
                                                            ...
                                                            <small class="mr-2"><i class="far fa-calendar-alt text-primary me-2 pr-2"></i>{{ date('D, d M Y', strtotime($blog->created_at))}}</small>
                                                        ...
                                                        <p class="text-justify blog-small-desc">{{ Str::limit(ucfirst($blog->small_desc), 250) }}</p>
                                    ...
                                    <div class="">
                                        <div class="blog-item bg-light rounded overflow-hidden">
                                            ...
                                            <div class="p-4">
                                                ...
                                                <a class="text-primary blog-link" href="{{ route('blogs','consultaing-service')}}">Read More <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                                    <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
                                                  </svg></a>
                                            </div>
                                        </div>
