                    ...
                    <div class="tab-content pt-2" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-benifits-infotrend" role="tabpanel" aria-labelledby="pills-benifits-infotrend-tab">
                            ...
                            <ul style="margin-left:-26px;">
                                ...
                                <li><strong>Global Service and Support:</strong> Worldwide presence for seamless installation and
                                    maintenance.</li>
                    ...
                    <div class="tab-content pt-2" id="pills-tabContent">
                        <div class="tab-pane fade show active " id="pills-introduction-dell" role="tabpanel" aria-labelledby="pills-introduction-dell-tab">
                            ...
                            <p class="mb-4 text-justify">Dell Technologies is revolutionising data management and infrastructure solutions,
                                ...
                                <p class="text-justify">Their approach to data management is centred around delivering simple and consistent
                                    cloud experiences, AI-based laptops, proactive storage solutions, and automated servers.
                                    By prioritising security, scalability, and efficiency, Dell enables organisations to accelerate
                                    from ideation to implementation rapidly.</p>
                        </div>
                        <div class="tab-pane fade mt-2 pt-3" id="pills-benifits-dell" role="tabpanel" aria-labelledby="pills-benifits-dell-tab">
                            <p class="mt-2 mb-3 text-justify">Dell has innovated data management solutions with devices made from reclaimed materials,
                            ...
                            <ul style="margin-left:-26px;">
                                ...
                                <li><strong>Scalable Performance:</strong>Dell PowerEdge servers offer scalable performance with
                                    Intel Xeon Scalable processors.

                                    </li>
                                <li><strong>Proactive Issue Resolution:</strong>PowerStore storage enables proactive monitoring and
                                    faster issue resolution.</li>
                                <li><strong>Sustainability:</strong>Dell's devices promote sustainability with reclaimed materials.</li>
                                <li><strong>Efficient Capacity Planning:</strong>PowerStore storage facilitates accurate capacity
                                    planning for optimised resources.</li>

                            </ul>

                        </div>
                        <div class="tab-pane fade mt-2 pt-3" id="pills-journey-dell" role="tabpanel" aria-labelledby="pills-journey-dell-tab">
                            <p class="mt-2 mb-3 text-justify">
                    ...
                    <div class="tab-content pt-2" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-introduction-ibm" role="tabpanel" aria-labelledby="pills-introduction-ibm-tab">
                            <p class="mb-4 text-justify"> IBM is a global leader in technology, renowned for its innovative solutions that empower
                                ...
                                <p class="text-justify">Over the years, IBM has established itself as a pioneer in data management, cloud
                                    ...
                                    solutions that empower organisations to unlock the full potential of their data assets, driving
                        ...
                        <div class="tab-pane fade" id="pills-benifits-ibm" role="tabpanel" aria-labelledby="pills-benifits-ibm-tab">
                            ...
                            <ul style="margin-left:-26px;">
                                ...
                                <li><strong>Enhanced Security:</strong>IBM solutions offer built-in governance and security features,
                                    ensuring data privacy and protection.</li>
                                <li><strong>Accelerated Innovation:</strong> IBM's advanced analytics, AI, and cloud computing drive
                        ...
                        <div class="tab-pane fade" id="pills-journey-ibm" role="tabpanel" aria-labelledby="pills-journey-ibm-tab">
                            <p class="mt-2 mb-3 text-justify">
                    ...
                    <div class="tab-content pt-2" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-introduction-couchbase" role="tabpanel" aria-labelledby="pills-introduction-couchbase-tab">
                            ...
                            <p class="mb-4 text-justify">Couchbase, a leading provider of distributed NoSQL cloud databases, stands out for its
                                ...
                                <p class="text-justify">Over the years, Couchbase has demonstrated impressive memory-first performance for
                        ...
                        <div class="tab-pane fade" id="pills-benifits-couchbase" role="tabpanel" aria-labelledby="pills-benifits-couchbase-tab">
                            ...
                            <ul style="margin-left:-26px;">
                                ...
                                <li><strong>Enhanced Performance and Security:</strong> With Couchbase Cloud, users benefit from
                                    enhanced performance and robust security measures, ensuring data and
                                    applications are safeguarded at all times.
                                    </li>
                                <li><strong>Cost Efficiency:</strong>Couchbase's offerings are designed to optimise costs, allowing
                                    businesses to reduce operating expenses while maximising productivity and
                                    performance.
                                </li>
                            </ul>
                        </div>
                        <div class="tab-pane fade" id="pills-journey-couchbase" role="tabpanel" aria-labelledby="pills-journey-couchbase-tab">
                            <p class="mt-2 mb-3 text-justify">
                    ...
                    <div class="tab-content pt-2" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-introduction-piconets" role="tabpanel" aria-labelledby="pills-introduction-piconets-tab">
                            ...
                            <p class="mb-4 text-justify"> picoNETS, established in 2017, is dedicated to enhancing the internet experience for users
                                ...
                                <p class="text-justify">With a steadfast commitment to optimising content delivery and software, picoNETS has
                        ...
                        <div class="tab-pane fade" id="pills-benifits-piconets" role="tabpanel" aria-labelledby="pills-benifits-piconets-tab">
                            ...
                            <ul style="margin-left:-26px;">
                                ...
                                <li><strong>Real-time Analytics:</strong>Gain insights into content popularity in real-time, allowing for
                                    customization and optimization of content delivery strategies.</li>

                            </ul>
                        </div>
                        <div class="tab-pane fade" id="pills-journey-piconets" role="tabpanel" aria-labelledby="pills-journey-piconets-tab">
                            <p class="mt-2 mb-3 text-justify">
                    ...
                    <div class="tab-content pt-2" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-introduction-redhat" role="tabpanel" aria-labelledby="pills-introduction-redhat-tab">
                            ...
                            <p class="mb-4 text-justify">Red Hat, an open-source software solutions company, has been instrumental in
                                ...
                                <p class="text-justify">With a legacy spanning more than 25 years, Red Hat has garnered the trust of over 90% of
                                    Fortune 500 companies, a testament to its unparalleled expertise and reliability. Notably, in
                        ...
                        <div class="tab-pane fade" id="pills-benifits-redhat" role="tabpanel" aria-labelledby="pills-benifits-redhat-tab">
                            ...
                            <ul style="margin-left:-26px;"> 
                                ...
                                <li><strong>Trusted Provider:</strong> With over 25 years of experience, Red Hat is relied upon by more
                                    than 90% of Fortune 500 companies for its enterprise open-source solutions.
                                    </li>
                                <li><strong>Innovation with Open Source:</strong>Red Hat fosters innovation through open technology,
                                    providing transparent and responsible solutions that drive flexibility and agility.
                                    </li>
                                <li><strong>Simplified Operations:</strong>Red Hat's solutions streamline operations, enhance
                                    productivity, and reduce complexity for businesses.
                                </li>
                                <li><strong>Security and Stability:</strong>Red Hat prioritises security, stability, and reliability in its
                                    solutions, ensuring confidence in IT infrastructure.
                                    </li>
                                <li><strong>Collaborative Development:</strong>Red Hat collaborates with open-source communities to
                    ...
                    <div class="tab-content pt-2" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-introduction-roombr" role="tabpanel" aria-labelledby="pills-introduction-roombr-tab">
                            <p class="mb-4 text-justify"> In the world of technological innovation, Roombr stands at the forefront, revolutionising the
                                ...
                                <p class="text-justify">By integrating computing and projection systems, Roombr transforms any wall into a
                                    life-sized interactive screen, offering a truly immersive experience. Gone are the days of 2D
                                    interactions; with Roombr, users step into a lifelike 3D computing environment, where virtual
                        ...
                        <div class="tab-pane fade" id="pills-benifits-roombr" role="tabpanel" aria-labelledby="pills-benifits-roombr-tab">
                            ...
                            <ul style="margin-left:-26px;">
                                ...
                                <li><strong>Global Connectivity:</strong> Connect with colleagues worldwide, turning any room into a
                                    shared workspace.</li>
                                <li><strong>Seamless Integration:</strong>Intuitively combine hardware and software for effortless
                                    virtual collaboration.
                                    </li>
                                <li><strong>High Performance:</strong>Enjoy powerful hardware specs for exceptional audiovisual
                                    quality.</li>
                                <li><strong>Efficient Workflow:</strong>Streamline collaboration with easy recording, archiving, and
