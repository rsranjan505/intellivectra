                            ...
                            <div class="row">
                                <form class="career-apply" id="career-apply" method="post" action="{{ route('career.apply.send')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary form-input-rounded ml-3 mt-4 px-4 text-center" type="submit">Send  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
