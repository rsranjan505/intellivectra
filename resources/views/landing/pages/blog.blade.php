        ...
        <div class="row g-5">
                            ...
                            <div class="blog-item bg-light rounded overflow-hidden">
                                ...
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        ...
                                        <small><i class="far fa-calendar-alt text-primary me-2 pr-2"></i>01 Mar, 2024</small>
                                    </div>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="form-rounded-serach w-100" >
                        <form action="">
                            <div class="input-group ">
                                ...
                                <input type="search" class="form-control border-0 p-3 input-form-serach-bg"   placeholder="Search">
                ...
                <div class="box-shadow px-3 p-2 ">
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        <div class="form-rounded-serach mb-2 mt-2">
