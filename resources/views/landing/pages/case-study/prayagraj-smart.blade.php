...
<div class="container-fluid pt-2 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container pt-2 py-4">
        <div class="text-center position-relative mx-auto">
            ...
            <div class="para1 "> <p class="mb-0 text-justify " >Prayagraj Smart City Limited (PSCL) is the special purpose vehicle created under the Smart City Mission to deliver several Pan City and Area Based Development Initiatives with a focus on both infrastructure and ICT advancements in the city and at strategic locations.
    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-6">
                ...
                <p>IVT has helped Prayagraj Smart City Limited to build a robust IT solution to enhance the academic performance of the students.</p>
