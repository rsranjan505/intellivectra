...
<div class="container-fluid py-2 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-3">
        <div class="box-shadow case-content row my-2 text-left py-4">
            ...
            <div class="col-lg-6 col-sm-12">
                <h3 class="pb-2"> <span class="text-primary"> Weather Forecast</span> Solutions</h3>
                <h5 class="mb-0 pb-1"><strong>Challenge:</strong></h5>
                <p class="mb-4 text-justify">Weather Forecast Solutions pioneers innovative IT services, specializing in the development of integrated command and control solutions for smart cities. With a focus on dynamic data analysis and security, they empower urban environments to make efficient, informed, and coordinated decisions, driving forward the evolution of modern city infrastructure.</p>
